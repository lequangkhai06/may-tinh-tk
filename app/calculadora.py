...
class Calculadora(object):
    def __init__(self, master):
        ...
        self._frame_input = tk.Frame(
            self.master, bg=self.theme['frame_bg'], pady=4)
        self._frame_input.pack()

        self._frame_buttons = tk.Frame(
            self.master, bg=self.theme['frame_bg'], padx=2)
    ...
    def _create_buttons(self, master):
        ...
        self._BTN_NUM_0 = tk.Button(
            master, text=0, cnf=self.theme['BTN_NUMERICO'])
        self._BTN_NUM_1 = tk.Button(
            master, text=1, cnf=self.theme['BTN_NUMERICO'])
        self._BTN_NUM_2 = tk.Button(
            master, text=2, cnf=self.theme['BTN_NUMERICO'])
        self._BTN_NUM_3 = tk.Button(
            master, text=3, cnf=self.theme['BTN_NUMERICO'])
        self._BTN_NUM_4 = tk.Button(
            master, text=4, cnf=self.theme['BTN_NUMERICO'])
        self._BTN_NUM_5 = tk.Button(
            master, text=5, cnf=self.theme['BTN_NUMERICO'])
        self._BTN_NUM_6 = tk.Button(
            master, text=6, cnf=self.theme['BTN_NUMERICO'])
        self._BTN_NUM_7 = tk.Button(
            master, text=7, cnf=self.theme['BTN_NUMERICO'])
        self._BTN_NUM_8 = tk.Button(
            master, text=8, cnf=self.theme['BTN_NUMERICO'])
        self._BTN_NUM_9 = tk.Button(
            master, text=9, cnf=self.theme['BTN_NUMERICO'])
        self.theme['BTN_OPERADOR'].update(self.settings['global'])
        self._BTN_SOMA = tk.Button(
            master, text='+', cnf=self.theme['BTN_OPERADOR'])
        ...
        self._BTN_DOT = tk.Button(
            master, text='.', cnf=self.theme['BTN_DEFAULT'])
        self._BTN_VAZIO1 = tk.Button(
            master, text='', cnf=self.theme['BTN_OPERADOR'])
        self._BTN_VAZIO2 = tk.Button(
            master, text='', cnf=self.theme['BTN_OPERADOR'])
        ...
        self._BTN_RAIZ['command'] = partial(
